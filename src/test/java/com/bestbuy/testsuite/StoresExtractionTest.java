...
public class StoresExtractionTest {
    ...
    public void getAdressOfNameRochester(){
        List<String>address = response.extract().path("data.findAll{it.name == 'Rochester'}.services");
...
//        List<String>StoreWindow=response.extract().path("data[7].services[5].storeservices");
//        System.out.println(StoreWindow);
    }
    @Test
