...
public class ProductsExtractionTest {
    ...
    @Test
    public void getAllDescriptionOfProducts() {
        List<String> numofDescription = response.extract().path("data.descripition");
        System.out.println("List of discription : " + numofDescription);
    }
    //32. Get id of all the all categories of all the products
    @Test
    public void getAllOfIdsOfCatogories(){
        List<String> numofIds = response.extract().path("data.categories.id");
        System.out.println("List of ids : " + numofIds);
    }
    ...
    @Test
    public void createdAtOfAllProducts(){
    ...
    public void allCategories(){
        List<String> allCat = response.extract().path("data.findAll{it.name=='Energizer - MAX Batteries AA (4-Pack)'}.categories");
        System.out.println("The all categories  are: " + allCat);
    }
    //37. Find the manufacturer of all the products
    @Test
    public void manufacturesAllProducts(){
